...
namespace gurleenProject.Controllers.ApplicationControllers
{
    public class StoresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StoreId,StoreName,Location,Date,Hours,Description")] Store store)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StoreId,StoreName,Location,Date,Hours,Description")] Store store)
        {
            if (id != store.StoreId)
            {
                return NotFound();
